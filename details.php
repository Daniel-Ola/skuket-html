...
<body>
	...
	<main>		
		<!-- <div class="hero_iner shop_detailer">
			<div class="wrapper">
				<span class="magnific-gallery">
					<a href="assets/images/banner1.jpg" class="btn_photos" title="Photo title" data-effect="mfp-zoom-in">View photos</a>
				...
				<div class="row">
					<div class="col-lg-8">
						<section id="description">
							<div class="detail_title_1">
								<h1>Product Name </h1>
								<a class="address" href="#">Amazing Grace Hostel, Adenike, Lautech Ogbomoso</a>
							</div>
							<p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Alias iste commodi maxime esse nisi tempore ducimus rem autem? Officiis, a. Deleniti id tenetur nulla vel facilis amet, perferendis fuga sapiente!</p>
							<p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Non quis facere natus tempore voluptate alias ab in possimus numquam eius earum saepe nisi maiores sint, eligendi, autem temporibus, ea aspernatur?</p>
							...
							<div class="opening">
                                <div class="ribbon">
                                    <span class="open">In Stock</span>
                                </div>
                                <i class="icon-photo"></i>
                                <h4>Photo</h4>
                                <div class="row mt-5">
										<div class="col-12 hero_in shop_detail" style="background: url(assets/images/product.jpg) no-repeat; background-size: cover;">
											<div class="wrapper">
												<span class="magnific-gallery">
													<a href="assets/images/banner1.jpg" class="btn_photos" title="Photo title" data-effect="mfp-zoom-in">View photos</a>
													<a href="assets/images/product.jpg" title="Photo title" data-effect="mfp-zoom-in"></a>
													<a href="img/gallery/hotel_list_3.jpg" title="Photo title" data-effect="mfp-zoom-in"></a>
												</span>
											</div>
										</div>
                            ...
                            <h5 class="mb-3">Related Offers <span class="float-right"><a href="seller.php?seller_id=xyz" style="text-decoration: none;">Ads from the same seller</a></span></h5>
                            <div class="row">
							<?php
								for($j=0; $j < 2; $j++) {
							?>
                                <div class="col-lg-6 col-md-12">
									...
									?>
                                        <li>
                                            <div class="thumb">
                                                <img src="assets/images/product.jpg" alt="" width="200" height="200" class="img-fluid">
                                            </div>
                                            <h6>Product Name <span>#12</span></h6>
                                            <p>
                                                Product location
                                            </p>
										</li>
					...
					<aside class="col-lg-4" id="sidebar">
						<div class="box_detail booking">
							<div class="price">
								<h5 class="d-inline">Contact <a href="seller.php?seller_id=xyz" title="View Adewale's profile">Seller</a> </h5>
							...
							<form method="post" action="assets/contact_detail.php" id="contact_detail" autocomplete="off">
								...
								<div class="form-group">
									<input placeholder="Are you human? 3 + 1 =" class="form-control" type="text" id="verify_contact_detail" name="verify_contact_detail" math="3+1">
								</div>
								<div class="form-group">
									<div class="alert alert-primary" role="alert">
										You're lucky Firstname is online, he should reply you right away
									</div>
									<div class="alert alert-warning" role="alert">
										Last time we spotted Adewale was 3min ago, don't worry we'll send a message to notify him
									</div>
									<input type="submit" value="Send Message" class="add_top_30 btn_1 full-width purchase" id="submit-contact-detail">
								</div>
			...
			<div class="row">
				...
				<div class="col-lg-3 col-md-6 col-sm-6">
					...
					<div class="collapse dont-collapse-sm" id="collapse_ft_2">
						<ul class="links">
							<li><a href="row-listings-filterscol-search-aside.html">Shops</a></li>
