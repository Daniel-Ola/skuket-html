		   ...
		   <div class="container">
			   <div class="row">
				   <div class="col-lg-3 col-md-4 col-10">
					   <h4><strong>145</strong> result from  <mark class="">Vehicle</mark></h4>
				   </div>
		...
		<div class="container margin_60_35">
			<div class="row">
				<aside class="col-lg-4" id="sidebar">
					<div id="filters_col">
						<a data-toggle="collapse" href="#collapseFilters" aria-expanded="false" aria-controls="collapseFilters" id="filters_col_bt">Seller's Profile </a>
						<div class="collapse show" id="collapseFilters">
							<div class="filter_type">
								...
								<div class="card">
                                    ...
                                    <div class="card-body">
                                        <h5 class="card-title"><strong>Name:</strong> Adewale Alata</h5>
                                        <p class="card-text"><strong>Joined:</strong> December 2010</p>
                                        <p class="card-text"><strong>Institution:</strong> Ladoke Akintola University of Technology, Ogbomoso (LAUTECH)</p>
                                    </div>
				...
				<div class="col-lg-8">
					<div class="strip list_view">
						<div class="row no-gutters">
							<div class="col-lg-5">
								<figure>
									<a href="details.php"><img src="assets/images/product.jpg" class="img-fluid" alt=""><div class="read_more"><span>View</span></div></a>
									<small>Car</small>
								</figure>
							</div>
							<div class="col-lg-7">
								<div class="wrapper">
									<a href="#0" class="wish_bt icon_heart_alt"></a>
									<h3><a href="details.php">Some Nice Car</a></h3>
									<small>Lasutech, Lagos</small>
									...
									<a class="address" href="assets/images/product.jpg">Get directions</a>
								</div>
								<ul>
									<li><span class="loc_open">In Stock - <span class="badge badge-warning">3</span></span></li>
					...
					<div class="strip list_view">
						<div class="row no-gutters">
							...
							<div class="col-lg-7">
								<div class="wrapper">
									<a href="#0" class="wish_bt icon_heart_alt"></a>
									<h3><a href="details.php">Get a Bus</a></h3>
									<small>Lasutech, Lagos</small>
									<p>Dicam diceret ut ius, no epicuri dissentiet philosophia vix. Id usu zril tacimates neglegentur. Eam id legimus torquatos cotidieque, usu decore percipitur definitiones ex, nihil utinam recusabo mel no.</p>
									<a class="address" href="assets/images/product.jpg">Get directions</a>
								</div>
